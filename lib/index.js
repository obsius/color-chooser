...
var Readout = (({
  ...
  }, mode.toUpperCase()), inputs), React.createElement("button", {
    onClick: onToggle
  }, "\u2194"));
});
...
class ColorChooser extends React.Component {
  ...
  render() {
    ...
    let spectrumSlider = React.createElement("div", {
    ...
    let alphaSlider = alpha && React.createElement("div", {
      ref: this.alphaRef,
    ...
    }, spectrumSlider, alphaSlider)), React.createElement(Readout, {
      color: this.color,
      mode: mode,
